...
#Falseの時dynamic_obstacle_mapの更新を無視，ドアをrelで通りたいときなど
...
#Trueの時dynamic_obstacle_mapの更新,障害物を考慮する
...
#現在の座標からx座標方向に2m相対移動,hsr navigation
...
lme.run(goal = goal, pose = None, destination_name = None, first_rotate = False, nav_type = "pumas", nav_mode = "abs", nav_timeout = 0, goal_distance = 0)
